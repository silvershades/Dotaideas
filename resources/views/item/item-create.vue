...
export default {
    ...
    methods: {
        ...
        deleteItemModifier: function (that) {
            Vue.delete(this.ditem.spell_attributes, that);
        },
        ...
        onFileChangeItem: function (payload) {
            ...
            this.ditem.image_show = URL.createObjectURL(file);
        ...
        initiateAjaxPost: function (event) {
            ...
            axios.post('/api/item-store', formData, {'content-type': 'multipart/form-data'})
                .then((response) => {
