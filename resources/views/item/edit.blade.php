...
@section('content')
    <item-edit inline-template v-cloak>
        <div>
            ...
            <div v-if="!loading">
                ...
                <div class="transition-all" :class="{'blur':publish_modal}">
                    <div class="rounded bg-primary-card shadow_caja  ">
                        <x-section-header>EDITING ITEM</x-section-header>
                        <div class="px-6 ">
                            ...
                            <div class="">
                                ...
                                <div class="rounded overflow-hidden shadow-lg shadow-primary-accent-sub">
                                    <div class="h-64 rounded-t gradient_placeholder">
                                        <img v-if="ditem.img_is_uploaded != 0" :src="ditem.img_path" alt="Her's portrait" class="w-full h-full object-cover">
                                    </div>
                                </div>
                                <div class="my-6">
                                ...
                                <div class="grid grid-cols-7 gap-4 mb-2">
                                    <div class="flex items-center justify-center">
                                        <img src="{{asset('/img/icons/gold2.png')}}" alt="gold dota 2" class="w-8 h-8">
                                    </div>
                                        ...
                                        <ul class="list-disc ml-6 mt-2">
                                            <li v-for="(mod, index) in ditem.recipe" class="uppercase text-sm">
                                                    <span class="flex items-center space-x-2">
                                                        <span class="font-semibold">@{{ mod.item }}</span>
                                                        <span>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="">
                                    ...
                                    <div class="w-full grid grid-cols-3 gap-4 ">
                                        <div>
                                            <input name="item_type" type="radio" id="primary_b1" class="hidden" v-model="ditem.item_type_id" value="1">
