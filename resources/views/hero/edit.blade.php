...
@section('content')
    <hero-edit inline-template v-cloak>
        <div>
            ...
            <div v-if="!loading">
                ...
                <div class="transition-all" :class="{'blur':publish_modal}">
                    <div class="rounded bg-primary-card shadow_caja pb-6 ">
                        <x-section-header>EDITING HERO</x-section-header>
                        <div class="">
                            ...
                            <div class="">
                                ...
                                <div class="rounded overflow-hidden shadow-lg shadow-primary-accent-sub">
                                    <div class="h-64 rounded-t gradient_placeholder">
                                        <img v-if="dhero.img_is_uploaded != 0" :src="dhero.img_path" alt="Hero's portrait" class="w-full h-full object-cover">
                                    </div>
                            ...
                            <div class="xl:col-span-2 mt-10 grid lg:grid-cols-2 gap-4 spell_box rounded p-4">
                                <div class="">
                                    ...
                                    <div class="w-full space-y-2 rounded-b py-2 mb-4">
                                        ...
                                        <div class="flex items-center justify-around space-x-2 ">
                                            <div>
                                                <input type="text" maxlength="22" class="input-sm py-0 w-full uppercase" placeholder="DAMAGE" v-model="spell_mod_key">
                                            </div>
                                            <div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            <input name="linkens" type="checkbox" id="linkens" class="hidden" v-model="current_spell.blocked_by_linkens">
                                            <label for="linkens" class="radio_label flex-col h-11 space-y-1">
                                        ...
                                        <div>
                                            <input name="cast_rooted" type="checkbox" id="cast_rooted" class="hidden" v-model="current_spell.cast_while_rooted">
                                            <label for="cast_rooted" class="radio_label flex-col h-11 space-y-1">
