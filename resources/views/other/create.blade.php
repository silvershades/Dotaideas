...
@section('content')
    <other-create inline-template v-cloak>
        <div>
            ...
            <div v-if="!loading">
                ...
                <div class="transition-all" :class="{'blur':publish_modal}">
                    <div class="rounded bg-primary-card shadow_caja  ">
                        <x-section-header>CREATING AN IDEA</x-section-header>
                        <div class="px-6 ">
                        ...
                        <div class="p-6 grid  lg:grid-cols-3 gap-8 ">
                            ...
                            <div class="">
                                ...
                                <select name="" class="w-full mb-4" v-model="dother.flag">
                                ...
                                <div class="rounded overflow-hidden shadow-lg shadow-primary-accent-sub">
                                    <div class="h-64 rounded-t gradient_placeholder">
                                        <img v-if="dother.image_show != ''" :src="dother.image_show" alt="Her's portrait" class="w-full h-full object-cover">
                                    </div>
                                </div>
                                <div class="my-6">
